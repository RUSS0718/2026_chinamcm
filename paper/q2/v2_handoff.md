...
- 人工复核：2026-08-09 已批准；接受代码哈希 `5182e532…` 的历史运行快照边界

本清单是 Q2 V2 修复材料的唯一论文交接入口。当前数字可用于 V2 方法与 n100 阶段性结果，但不得写成 n200 正式选型、最终模型或竞赛最终结论。
...
4. 已确认全量 `unittest` 19/19 通过，并核对报告、汇总表、快照和代码入口参数；人工复核接受历史运行快照边界。
